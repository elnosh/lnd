...
const (
	...
	// ExperimentalAccountable is the value that the experimental accountable
	// field contains when a htlc is accountable. We're using a single byte
	// to represent our accountable value, but limit the value to using
